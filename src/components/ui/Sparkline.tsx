...
export default function Sparkline({ value, isOnline = true, isOverloaded = false, color = 'var(--tech-cyan)' }: SparklineProps) {
  const maxHistory = 20;
  const width = 120;
  const height = 30;
  ...
  useEffect(() => {
    ...
    }, isOverloaded ? 150 : 400); // Стресс-график бежит в 2.5 раза быстрее!
